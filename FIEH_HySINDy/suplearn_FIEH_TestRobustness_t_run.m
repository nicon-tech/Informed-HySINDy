%% FIEH training - supervised learning
...
for eps = eps_vect %noise level
    ...
    for thick_unddata = thick_unddata_vect %range undefined data position
        ...
        tend = 11; %TEST NICO 4.1373 time to complete an orbit; 12 time for training; 17 time for predict
        dt = 0.0001; %TEST NICO 0.0001
        tspan = 0:dt:tend;
