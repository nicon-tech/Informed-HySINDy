function [Xistruct] = multiD_Lambda_for_Ex_Jumping_Noise_Datasets(Thetalib,lambdavals)
...
if isfield(lambdavals,'method') % lambdavals could be constructed in some different way
...
lambda_index = permn(1:numlambda,nstates); %create a matrix of size (numlambda^nstates , nstate)
