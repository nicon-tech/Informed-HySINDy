%% main code - Hopping - supervised learning 
...
y_out_training1 = data_training.yout;
a_out_training1 = data_training.aout;
t_out_training1 = data_training.tout;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%training data 2
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear data_training
...
figure
[data_training]  = RUN_Hopper(p);
y_out_training2 = data_training.yout;
a_out_training2 = data_training.aout;
t_out_training2 = data_training.tout;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%training data 3
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear data_training
...
figure
[data_training]  = RUN_Hopper(p);
y_out_training3 = data_training.yout;
a_out_training3 = data_training.aout;
t_out_training3 = data_training.tout;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


plot_index_switch = find(y_out(:,1) == xswitch_median);
y0_spring = [1  -1.13093]; %for data set ...
y0_flight = [1   1.13093]; %for data set ...
   
tspan_spring = 0;
tspan_flight = 0;
for mm=1:numel(t_out_spring)-144 %we cut 144 points to avoid that springing dynamic continue beyond its own manifold
    tspan_spring = [tspan_spring mm*dt];
end
for mm=1:numel(t_out_flight)-256 %we cut 268 points to avoid that flying dynamic continue beyond its own manifold
...
figure
plot(y_out(:,1),y_out(:,2),'k--','LineWidth',0.9) % measurement - validation data
hold on
plot(y_out_training1(:,1),y_out_training1(:,2),'k-','LineWidth',0.9) % measurement - training data
...
plot(y_out_training2(:,1),y_out_training2(:,2),'k-','LineWidth',0.9) % measurement - training data
plot(y_out_training3(:,1),y_out_training3(:,2),'k-','LineWidth',0.9) % measurement - training data
